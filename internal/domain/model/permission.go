...
const (
	PrefixPermissionChapter Permission = "permission:chapter:"

	PermissionChapterList   Permission = PrefixPermissionChapter + "list"
	PermissionChapterCreate Permission = PrefixPermissionChapter + "create"
	PermissionChapterUpdate Permission = PrefixPermissionChapter + "update"
	PermissionChapterDelete Permission = PrefixPermissionChapter + "delete"
)
