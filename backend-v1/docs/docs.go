...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/value.CreateChapterAssignmentArgs"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/value.CreateChapterAssignmentResult"
                        }
                    }
                }
            }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/value.UpdateAssignmentArgs"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/value.CreateComicArgs"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/value.CreateComicResult"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/value.CreateTeamResult"
                        }
                    }
                }
            }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/value.UnitInfo"
                            }
                        }
                    }
                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/value.SavePageUnitArgs"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "value.CreateChapterAssignmentArgs": {
            "type": "object",
            "properties": {
                "chapter_id": {
                    "type": "string"
        ...
        "value.CreateChapterAssignmentResult": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
        ...
        "value.SavePageUnitArgs": {
            ...
            "properties": {
                ...
                "unit_diff": {
                    "$ref": "#/definitions/value.UnitDiff"
                }
            }
        },
        "value.TeamInfo": {
        ...
        "value.UnitDiff": {
            ...
            "properties": {
                ...
                "insert": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/value.UnitCreation"
                    }
                },
                "patch": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/value.UnitPatch"
                    }
                }
            }
        },
        ...
        "value.UnitPatch": {
            ...
            "properties": {
                ...
                "is_proofread": {
                    "$ref": "#/definitions/util.Option-bool"
                },
                "page_id": {
                    "type": "string"
                },
