...
**章节来源**
- [user.go:96-135](file://internal/api/http/user.go#L96-L135)
...
**章节来源**
- [user.go:137-175](file://internal/api/http/user.go#L137-L175)
...
3. **领域层依赖基础设施层**：通过仓储模式访问数据库
4. **外部库集成**：JWT 用于身份认证，bcrypt 用于密码加密
...
该接口文档为开发者提供了全面的技术参考，有助于快速理解和使用用户管理相关的 API 功能。