    ...
    "paths": {
        ...
        "/api/v1/assignments/users/{user_id}": {
            "get": {
                ...
                "description": "List assignments of one user\nThe caller must be super admin or the target user himself\nAuth: ` + "`" + `authorization` + "`" + ` cookie is preferred over ` + "`" + `Authorization` + "`" + ` header when both are present",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/api/v1/users/{user_id}/avatar/confirm": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "val.CreateComicArgs": {
            ...
            "properties": {
                ...
                "first_chapter_title": {
                    "description": "` + "`" + `FirstChapterTitle` + "`" + ` is the title for the first chapter to be created together with the comic\nIf empty, a default chapter titled \"CH.0\" will be created",
                    "type": "string"
                },
                "title": {
